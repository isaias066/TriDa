// TriDa - Frontend Solo (sin datos reales)
...
export const ROLES = [
  { id: 'admin', label: 'Administrador', color: '#6366F1', desc: 'Gestión del sistema' },
  { id: 'analyst', label: 'Analista', color: '#06B6D4', desc: 'Análisis de datos' },
  { id: 'operator', label: 'Operador', color: '#10B981', desc: 'Monitoreo' },
];
